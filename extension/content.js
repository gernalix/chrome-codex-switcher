(() => {
  ...
  note.addEventListener("input", () => {
    ...
    noteTimer = setTimeout(() => send({type: "context:note", contextId: context.id, note: note.value}), 220);
  });
